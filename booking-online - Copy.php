...
<div class="fcf-form-group">
    <label for="startdatebooking" class="fcf-label">Start Date- EG (04/22): (Optional)		 </label>
...
<div class="fcf-form-group">
    <label for="enddatebooking" class="fcf-label">End Date- EG (07/26): (Optional)		 </label>
