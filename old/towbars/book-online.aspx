...
<!-- #EndLibraryItem --><!-- #BeginLibraryItem "/Library/menu.lbi" --><div id="menu">
  ...
  <webxelmail:mail ID="WxlMailer" Offline="false" DisplayBody="true" From='send@jdbsolutions.co.uk' SenderName='<%# Request.Form["frmName"] %>' Recipient='enquiries@buchansfortowbars.co.uk' cc='<%# Request.Form["frmEmail"] %>' ReplyTo='<%# Request.Form["frmEmail"] %>' Subject="Online Towbar Booking - Buchans for Towbars" Body="booking_template.htm" SmtpUser="" SmtpPassword="" AuthenticationMode="Basic" SmtpServer="127.0.0.1" RegEmail="webxel.com" RegKey="T1HpsAHs1S9PoK1RhwSbuQ==" runat="server">
	<webxelmail:ControlCloak ControlToCloak='TblToHideOnSend' runat="server"></webxelmail:ControlCloak>
        ...
        <table border="0" cellpadding="1" cellspacing="0" id="TblToHideOnSend" runat="server">
          <tr>
            <td height="35" colspan="2"> <p>Please Note: There will Be a £100 Deposit Taken from your Card Below once your booking has been confirmed (If you decide to cancel the booking this deposit is NON REFUNDABLE) 
</tr>
Please enter your full requirements below. Help us to better meet your needs by giving us as much information as possible.
</p></td>
          </tr>
          <tr>
          ...
          <tr>
            <td class="frmfldName">Discount Code:</td>
            <td class="validation"><input name="frmDisc" type="text" class="formfield200" id="frmDisc" size="7" runat="server"></td>
          </tr>
          <tr>
...
<td class="frmfldName">Fitting Center:</td>
	...
	<tr title="The booking date must be at least 5 working days in advanced to allow us to reserve a booking slot for you and also to allow us to order any other parts that are required for your vehicle.                                                                      Please Note: We are not open on Saturday afternoons or Sundays!">
            <td valign="top" class="frmfldName">Booking Date: ... At Least 5 Working Days In Advanced DD/MM/YYYY</td>
...
<td class="frmfldName">Booking Time:...... Only 08:30am On Saturdays!</td>
	...
	<tr title="This option must be chosen if you are going for a detachable type towbar as there is only one socket plate on detachable towbars so if you have two sockets and require a detachable you must go with the 13 pin & Flylead. Note: A Split Charge Relay can be added to double electrics when towing a caravan to prevent your car battery being drained by your caravan when stationery..">
          ...
          <tr>
            <td class="frmfldName">Card Type: </td>
            <td class="validation">
			<select name="frmCardType" class="formfielddd" id="frmCardType" runat="server">
		...
		<option value="Other (Specify Below)">Other (Specify Below)</option>												
            </select> <asp:RequiredFieldValidator ID="RequiredFieldValidator22" EnableClientScript="true" Display="Dynamic" ErrorMessage="Card Type Required" ControlToValidate="frmCardType" runat="server"></asp:RequiredFieldValidator>              </td>
         </tr>
	<tr>
            <td height="23" class="frmfldName">Card Number: </td>
            <td valign="bottom" class="validation"><font color="#999999">
              <input name="frmCardNo" type="text" class="formfield200" id="frmCardNo" size="20" runat="server">
              <asp:RequiredFieldValidator ID="RequiredFieldValidator23" EnableClientScript="true" Display="Dynamic" ErrorMessage="Card Number Required" ControlToValidate="frmCardNo" runat="server"></asp:RequiredFieldValidator>
            </font></td>
	</tr>
	<tr>
            <td height="23" class="frmfldName">Start Date E.G.02/10: </td>
            <td valign="bottom" class="validation"><font color="#999999">
              <input name="frmStartDate" type="text" class="formfield200" id="frmStartDate" size="5" runat="server">
              <asp:RequiredFieldValidator ID="RequiredFieldValidator24" EnableClientScript="true" Display="Dynamic" ErrorMessage="Card Start Date Required" ControlToValidate="frmStartDate" runat="server"></asp:RequiredFieldValidator>
            </font></td>
	</tr>
	<tr>
            <td height="23" class="frmfldName">End Date E.G.08/14: </td>
            <td valign="bottom" class="validation"><font color="#999999">
              <input name="frmEndDate" type="text" class="formfield200" id="frmEndDate" size="5" runat="server">
              <asp:RequiredFieldValidator ID="RequiredFieldValidator25" EnableClientScript="true" Display="Dynamic" ErrorMessage="Card End Date Required" ControlToValidate="frmEndDate" runat="server"></asp:RequiredFieldValidator>
            </font></td>
	</tr>
	<tr>
            <td height="23" class="frmfldName">Security No: </td>
            <td valign="bottom" class="validation"><font color="#999999">
              <input name="frmSecNo" type="text" class="formfield200" id="frmSecNo" size="3" runat="server">
              <asp:RequiredFieldValidator ID="RequiredFieldValidator26" EnableClientScript="true" Display="Dynamic" ErrorMessage="Card Security Number Required" ControlToValidate="frmSecNo" runat="server"></asp:RequiredFieldValidator>
            </font></td>
 	</tr>
          <tr>
