...
<!-- #EndLibraryItem --><!-- #BeginLibraryItem "/Library/menu.lbi" --><div id="menu">
  ...
  <webxelmail:mail ID="WxlMailer" Offline="false" DisplayBody="true" From='send@jdbsolutions.co.uk' SenderName='<%# Request.Form["frmName"] %>' Recipient='enquiries@buchansfortowbars.co.uk' cc='<%# Request.Form["frmEmail"] %>' ReplyTo='<%# Request.Form["frmEmail"] %>' Subject="Towbar Quote - Buchans for Towbars" Body="quote_template.htm" SmtpUser="" SmtpPassword="" AuthenticationMode="Basic" SmtpServer="127.0.0.1" RegEmail="webxel.com" RegKey="T1HpsAHs1S9PoK1RhwSbuQ==" runat="server">
	<webxelmail:ControlCloak ControlToCloak='TblToHideOnSend' runat="server"></webxelmail:ControlCloak>
        ...
        <table border="0" cellpadding="1" cellspacing="0" id="TblToHideOnSend" runat="server">
          ...
          <tr>
           ...
           <asp:RequiredFieldValidator ID="RequiredFieldValidator55" EnableClientScript="true" Display="Dynamic" ErrorMessage="Telephone Number Required" ControlToValidate="frmTelephone" runat="server"></asp:RequiredFieldValidator></td>
          </tr>
          <tr>
	...
	<option value="Volvo">Volvo</option>
          ...
          <tr>
            <td class="frmfldName">Registration No: </td>
            <td class="validation"><font color="#999999">
              <input name="frmPrefix" type="text" class="formfield200" id="frmPrefix" size="15" runat="server">
              <asp:RequiredFieldValidator ID="RequiredFieldValidator52" EnableClientScript="true" Display="Dynamic" ErrorMessage="Registration Required" ControlToValidate="frmPrefix" runat="server"></asp:RequiredFieldValidator>
            </font></td>
	</tr>
	<tr>
 	<td class="frmfldName">Reversing Sensors: </td>
            <td class="validation">
			<select name="frmSensors" class="formfielddd" id="frmSensors" runat="server">
                <option value="" selected>Select Sensors Fitted Yes/No</option>
                <option value="Yes">Yes</option>
                <option value="No">No</option>
                <option value="Not Sure">Not Sure</option>												
            </select> <asp:RequiredFieldValidator ID="RequiredFieldValidator54" EnableClientScript="true" Display="Dynamic" ErrorMessage="Sensors" ControlToValidate="frmSensors" runat="server"></asp:RequiredFieldValidator>              </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td title="Single electrics are required to power indicators, tail, side, brake and fog lights."><table 
...
="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<tr title="This option for electrics is if you are towing a caravan or you have a cycle carrier with a 13 pin plug fitted (Note: Most new caravans from September 2008 onwards normally come with this fitted!).">
                <td><input name="radiobutton" type="radio" value="European 13 Pin"></td>
                <td>European 13 Pin</td>
      		</tr>
	<tr title="This option must be chosen if you are going for a detachable type towbar as there is only one socket plate on detachable towbars so if you have two sockets and require a detachable you must go with the 13 pin & Flylead.">
                <td><input name="radiobutton" type="radio" value="European 13 Pin With Flylead"></td>
                <td>European 13 Pin With Flylead</td>
            </table>                          </td>
          </tr>
          <tr>
